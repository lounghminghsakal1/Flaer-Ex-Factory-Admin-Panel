...
const DUMMY_BATCHES = [
  { id: 1, batch_code: "BATCH1" },
  { id: 2, batch_code: "BATCH2" },
  { id: 3, batch_code: "BATCH3" },
  { id: 4, batch_code: "B-11" },
  { id: 5, batch_code: "B-12" },
];

export default function BatchInventoryFilters({
  draftFilters = {},
  setDraftFilters,
  appliedFilters = {},
  onApply,
    ...
    <div className="w-full mx-auto my-4">
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        <SearchableDropdown
          ...
          value={draftFilters.by_batch}
          onChange={(val) => setDraftFilters((prev) => ({ ...prev, by_batch: val }))}

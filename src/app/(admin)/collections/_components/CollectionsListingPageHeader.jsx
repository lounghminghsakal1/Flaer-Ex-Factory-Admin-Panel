...
export default function CollectionsListingPageHeader({ onCollectionCreated }) {
  ...
  return (
    <div className="flex justify-between items-center mb-4">
      ...
      <div>
        <button className="flex bg-blue-800 text-gray-100 px-4 py-2 rounded-md cursor-pointer hover:bg-blue-600 " onClick={() => router.push("/collections/create")}><span><Plus /></span> Create Collection</button>
      </div>
